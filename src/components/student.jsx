...
useEffect(() => {
  ...
  async function  Load()
  {
    ...
    try
        {
         await axios.post("http://localhost:8090/api/v1/student/save",
        {
   ...
   {
        await axios.delete("http://localhost:8090/api/v1/student/delete/" + studentid); 
   ...
   try
       {
        await axios.put("http://localhost:8090/api/v1/student/edit/" + studentid ,
       {
    ...
    <div>
       ...
       <div class="container mt-4" >
          <form>
              ...
              <div>
              <button class="btn btn-primary mt-4" style={{ marginRight: '10px' }} onClick={save}>Register</button>
